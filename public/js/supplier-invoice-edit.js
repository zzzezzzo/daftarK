...
document.addEventListener("DOMContentLoaded", function () {
    console.log("=== SUPPLIER INVOICE EDIT PAGE LOADED ===");
    console.log("window.invoiceItems:", window.invoiceItems);
    console.log("window.products:", window.products);

    if (window.invoiceItems) {
        console.log("=== LOADING EXISTING PRODUCTS ===");
        console.log("Invoice items count:", window.invoiceItems.length);
        
        window.invoiceItems.forEach((item, index) => {
            ...
            console.log(`Adding invoice product ${index}:`, invoiceProduct);
            invoiceProducts.push(invoiceProduct);
        });

        console.log("Final invoice products:", invoiceProducts);
        renderProducts();
        updateTotal();
    } else {
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (form) {
        form.addEventListener("submit", function(e) {
            ...
            console.log("Invoice products length:", invoiceProducts.length);
