    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-4">
        <div class="max-w-7xl mx-auto">
            ...
            @if ($outofstockProduct->count() > 0)
                <div class="bg-red-50 h-[350px] overflow-hidden dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-300 px-6 py-4 rounded-xl mb-6 flex gap-3">
                    ...
                    <div class="flex flex-col flex-1 min-h-0">
                        <p class="font-semibold mb-2 flex-shrink-0">
