                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-blue-100 text-sm">تعديل بيانات المنتج: {{ $product->name }}</p>
                            </div>
                        </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    <input 
                                        ...
                                        name="price_base" 
                                        id="price_base"
                                        value="{{ old('price_base', $product->price_base) }}"
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    <input 
                                        ...
                                        name="price_trade" 
                                        id="price_trade"
                                        value="{{ old('price_trade', $product->price_trade) }}"
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    <input 
                                        ...
                                        id="price_technician"
                                        value="{{ old('price_technician', $product->price_technician) }}"
                                        class="w-full p-4 pr-12 border border-gray-300 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 dark:bg-gray-700 dark:text-white transition-all">
                                    <div class="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-400">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    <input 
                                        ...
                                        name="price_customer" 
                                        id="price_customer"
                                        value="{{ old('price_customer', $product->price_customer) }}"
                                        class="w-full p-4 pr-12 border border-gray-300 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 dark:bg-gray-700 dark:text-white transition-all">
                                    <div class="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-400">
