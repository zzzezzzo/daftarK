        ...
        <div class="max-w-[22rem] mx-auto w-full print:w-full print:max-w-none print:mx-0">
            ...
            <article
                ...
                <section class="text-xs text-gray-700 mb-1 border-b border-dotted border-zinc-400 pb-4 print:text-[10pt] print:space-y-1.5 print:pb-3">
                    ...
                    <div class="flex justify-between gap-3">
                        ...
                        <span class="font-medium tabular-nums">{{ $invoice->date instanceof \Carbon\Carbon ? $invoice->date->format('Y-m-d') : $invoice->date }}</span>
                    </div>
                    <div class="flex justify-between gap-3 items-start">
                        <span class="text-gray-500 shrink-0">المورد</span>
                        <span class="font-medium text-right leading-snug">{{ $supplier->name }}</span>
                    </div>
                    @if($supplier->phone)
                        <div class="flex justify-between gap-3">
                ...
                <section class="space-y-2 text-sm mb-1 print:text-[10pt] print:space-y-1 print:mb-1">
                    ...
                    <div class="flex justify-between gap-3 text-xs print:text-[10pt]">
                        ...
                        <span class="tabular-nums font-medium">{{ number_format($remainingAmount, 2) }} ج.م</span>
                    </div>
                </section>
            ...
            <div class="no-print flex flex-col gap-4 mt-5">
                <div class="flex flex-col sm:flex-row gap-3 justify-center">
                    ...
                    <button type="button"
                            onclick="window.open('{{ route('accountStatement.edit', [$supplier->id, $invoice->id]) }}', '_blank')"
