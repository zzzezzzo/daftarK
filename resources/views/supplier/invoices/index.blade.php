                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-blue-100 text-sm">إدارة جميع فواتير الموردين</p>
                            </div>
                        </div>
                ...
                <form action="{{ route('supplier.invoices.index') }}" method="GET" class="flex flex-col md:flex-row gap-4">
                    <div class="relative flex-1">
                        ...
                        <input
                            ...
                            placeholder="ابحث عن فاتورة بالرقم أو المورد..."
                            ...
                            @forelse($invoices as $invoice)
                                <tr class="hover:bg-blue-50 dark:hover:bg-gray-700 transition-colors">
                                    ...
                                    <td class="p-4 text-gray-600 dark:text-gray-400">
                                        {{ $invoice->date instanceof \Carbon\Carbon ? $invoice->date->format('Y-m-d') : $invoice->date }}
                                    </td>
