                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-blue-100 text-sm">تعديل معلومات العميل: {{ $customer->name }}</p>
                            </div>
                        </div>
                ...
                <form action="{{ route('customer.update', $customer->id) }}" method="POST" class="space-y-8">
                    ...
                    <div class="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-700 dark:to-gray-600 p-6 rounded-xl border border-blue-200 dark:border-gray-500 mb-6">
                        <div class="flex items-center gap-4 mb-4">
                            ...
                            <div>
                                <h3 class="text-lg font-semibold text-gray-800 dark:text-white">{{ $customer->name }}</h3>
                                <p class="text-sm text-gray-500 dark:text-gray-400">
                                    {{ $customer->type == 'permanent' ? 'عميل دائم' : 'عميل مؤقت' }} • 
                                    {{ $customer->phone }}
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-700 dark:to-gray-600 p-6 rounded-xl border border-blue-200 dark:border-gray-500">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <label class="relative cursor-pointer">
                                <input type="radio" name="type" value="permanent" class="peer sr-only" {{ old('type', $customer->type) == 'permanent' ? 'checked' : '' }}>
                            ...
                            <label class="relative cursor-pointer">
                                <input type="radio" name="type" value="walkin" class="peer sr-only" {{ old('type', $customer->type) == 'walkin' ? 'checked' : '' }}>
                    ...
                    <div class="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 p-6 rounded-xl border border-green-200 dark:border-green-700">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <label class="relative cursor-pointer">
                                <input type="radio" name="price_type" value="client" class="peer sr-only" {{ old('price_type', $customer->price_type) == 'client' ? 'checked' : '' }}>
                            ...
                            <label class="relative cursor-pointer">
                                <input type="radio" name="price_type" value="trade" class="peer sr-only" {{ old('price_type', $customer->price_type) == 'trade' ? 'checked' : '' }}>
                                <div class="p-4 border-2 border-gray-200 dark:border-gray-600 rounded-xl peer-checked:border-blue-500 peer-checked:bg-blue-50 dark:peer-checked:bg-blue-900/20 transition-all hover:border-blue-300">
                                    <div class="flex items-center gap-3">
                            ...
                            <label class="relative cursor-pointer">
                                <input type="radio" name="price_type" value="technical" class="peer sr-only" {{ old('price_type', $customer->price_type) == 'technical' ? 'checked' : '' }}>
